...
\input{workpackages/wp1} % Inlezen van werkpakket 1
\input{workpackages/wp2} % Inlezen van werkpakket 2
\input{workpackages/wp3} % Inlezen van werkpakket 3
\input{workpackages/wp4} % Inlezen van werkpakket 4
\input{workpackages/wp5} % Inlezen van werkpakket 5
\input{workpackages/wp6} % Inlezen van werkpakket 6
\input{workpackages/wp7} % Inlezen van werkpakket 7
